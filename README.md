...
- 1GB 패키지와 10분 추론 제약에서 **HyperCLOVA X 0.5B** 3개를 앙상블해 팀 Macro-F1을 **0.4358 → 0.7977**로 개선했습니다.
...
- **[LG AIMERS 9기](https://github.com/jinsan02/lg-aimers-9-hackathon)** — 투구 제구 성공 확률 예측, 노이즈 플로어 기반 판정으로 축 202개를 정리, 상위 19.5%(212위/1,090팀)
